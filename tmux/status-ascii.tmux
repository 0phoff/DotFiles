...
set -g status-right "#{?GITMUX_REPO,#[fg=brightblack][#{?GITMUX_REMOTE,#[fg=blue]⎇ #{GITMUX_BRANCH},#[fg=red]⎇ #[fg=blue]#{GITMUX_BRANCH}}#[fg=brightblack]][#[fg=red]#{GITMUX_UNTRACKED} #[fg=yellow]#{GITMUX_CHANGED} #[fg=green]●#{GITMUX_STAGED}#[fg=brightblack]]╾─╼,}#[fg=brightblack][#[fg=blue]%H:%M#[fg=brightblack]]╾─╼[#[fg=cyan]#U#[fg=brightblack]]#[fg=brightblack][#[fg=cyan]#H#[fg=brightblack]]"
