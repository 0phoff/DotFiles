...
map global shortcuts y '<a-|> xclip -i -d :0 -selection clipboard<ret>'                     -docstring 'yank into the clipboard'
map global shortcuts p '<a-!> xclip -o -d :0 -selection clipboard<ret>'                     -docstring 'paste from the clipboard'
